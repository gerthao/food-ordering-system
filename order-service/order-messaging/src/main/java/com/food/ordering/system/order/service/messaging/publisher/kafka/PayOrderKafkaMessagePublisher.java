...
public class PayOrderKafkaMessagePublisher implements OrderPaidRestaurantRequestMessagePublisher {
    ...
    public void publish(OrderPaidEvent domainEvent) {
        ...
        try {
            producer.send(
                    new ProducerRecord<>(configData.getPaymentRequestTopicName(), orderId.toString(), restaurantApprovalRequestAvroModel),
                    messageHelper.getKafkaCallback(configData.getPaymentRequestTopicName(), orderId.toString(), "RestaurantApprovalRequestAvroModel", restaurantApprovalRequestAvroModel)
            );
