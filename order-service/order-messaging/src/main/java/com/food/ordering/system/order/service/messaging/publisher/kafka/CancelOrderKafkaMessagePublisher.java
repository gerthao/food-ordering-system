...
import com.food.ordering.system.order.service.domain.ports.output.message.publishing.payment.OrderCancelledPaymentRequestMessagePublisher;
...
public class CancelOrderKafkaMessagePublisher implements OrderCancelledPaymentRequestMessagePublisher {
    ...
    public CancelOrderKafkaMessagePublisher(OrderMessagingDataMapper mapper, OrderServiceConfigData configData, KafkaProducer<String, PaymentRequestAvroModel> producer, OrderKafkaMessageHelper messageHelper) {
        this.mapper        = mapper;
    ...
    public void publish(OrderCancelledEvent domainEvent) {
        ...
        try {
            ...
            producer.send(
                    ...
                    messageHelper.getKafkaCallback(configData.getPaymentRequestTopicName(), orderId.toString(), "PaymentRequestAvroMdoel", paymentRequestAvroModel)
            );
